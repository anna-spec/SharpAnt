                ...
                <ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/ui-ux-design">UI/UX Design</a>
                            <a class="dropdown-item" href="/development">Development</a>
                            <a class="dropdown-item" href="/seo">SEO Optimization</a>
                        </div>
                    </li>
                    <li class="nav-li"><a href="/portfolio">Portfolio</a></li>
                    <li class="nav-li"><a href="">Testimonials</a></li>
                    <li class="nav-li"><a href="">Cooperations</a></li>
                    <li class="nav-li"><a href="">Team</a></li>
                    <li class="nav-li"><a href="/contacts">Contact us</a></li>
                </ul>
            </nav>
        </div>
    </div>
